...
class YuLibHeaderBlock extends BlockBase {
  ...
  public function build() {
    ...
    $header01 = '<div id="branding" class="container">
	  ...
	  <div id="yul-wpml-dropdown" class="px-2"><a class="btn btn-outline-dark rounded-0" href="https://www.library.yorku.ca/web/frost/?lang=fr" class="">French (Français)</a></li></div>
    ...
    $build['yu_lib_footer_block']['#markup'] = $header01;
    return $build;
  }
}
